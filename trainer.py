    ...
    def train(self):
        ...
        for epoch in range(self.opt.nepochs):
            ...
            for i, (datas, datat) in enumerate(zip(self.source_trainloader, self.targetloader)):
                ...
                errD_src_real_c = self.criterion_c(src_realoutputD_c, src_labelsv) * self.opt.cls_w
                ...
                self.netG.zero_grad()       
                src_fakeoutputD_s, src_fakeoutputD_c = self.netD(src_gen)
                errG_c = self.criterion_c(src_fakeoutputD_c, src_labelsv) * self.opt.cls_w
                ...
                src_fakeoutputD_s, src_fakeoutputD_c = self.netD(src_gen)
                errF_src_fromD = self.criterion_c(src_fakeoutputD_c, src_labelsv)*(self.opt.adv_weight) * self.opt.cls_w
